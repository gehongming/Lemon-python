...
from work_pytest.PageObjects.ketangpai_homework_page import HomeworkPage as hp
from work_pytest.PageObjects.ketangpai_letter_page import LetterPage as le
from work_pytest.PageObjects.ketangpai_main_page import MainPage as mp
